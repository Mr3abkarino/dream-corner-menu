...
// شعار المطعم الأصلي بصيغة Base64 كامل ومحمي وبدون أي تظليل أو اختزال
...
function App() {
  ...
  // صياغة آمنة تماماً لتجنب الأخطاء في التجميع
        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0">
            <div onClick={handleLogoClick} className="cursor-pointer active:scale-95 transition-transform shrink-0 relative">
              ...
              />
              {logoClicks > 0 && (
                <span className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-red-600 text-white rounded-full flex items-center justify-center text-[9px] font-bold">
                  {logoClicks}
                </span>
              )}
            </div>
