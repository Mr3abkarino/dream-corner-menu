          ...
          <Sheet theme={theme} title="تأكيد إعادة التعيين" onClose={() => setShowResetConfirm(false)}>
            <div className="space-y-4 text-center">
              ...
              <div className="flex gap-2 justify-center">
                ...
                <button onClick={() => setShowResetConfirm(false)} className="px-4 py-2 border rounded-lg text-xs font-bold" style={{ borderColor: (theme.muted || "#B3A18C") + "40" }}>إلغاء</button>
              </div>
            </div>
          </Sheet>
        </Overlay>
...
// التصدير الافتراضي النظيف في سطر منفصل لحل التعارضات نهائياً
export default App;
