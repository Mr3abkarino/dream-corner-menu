...
export default function RestaurantMenu() {
  ...
  const [activeCat, setActiveCat] = useState("الكل"); // تم تصحيح الـ State هنا لتفادي الشاشة البيضاء
              ...
              <>
                ...
                <div className="mt-3 pt-2 border-t border-dashed space-y-2" style={{ borderColor: theme.accent + "30" }}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <textarea placeholder="أي ملاحظات إضافية على الأكل؟ (بدون بصل، الكرانشي بارد...)" value={customerNotes} onChange={(e) => setCustomerNotes(e.target.value)} rows={1} className="w-full px-3 py-2 pr-9 rounded-xl text-xs border focus:outline-none resize-none" style={{ background: theme.surface2, borderColor: theme.accent + "30", color: theme.text }} />
